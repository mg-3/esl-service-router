 ...
 *       &lt;sequence>
 *         &lt;element name="queryMsagDataReturn" type="{http://xml.blackbean.com/location/types}QueryMsagDataResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryMsagDataResponse", namespace = "http://xml.blackbean.com/location/services")
public class QueryMsagDataResponse {

    @XmlElementRef(name = "queryMsagDataReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
