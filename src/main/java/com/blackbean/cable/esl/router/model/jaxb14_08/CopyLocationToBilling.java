 ...
 *       &lt;sequence>
 *         &lt;element name="CopyLocationToBilling" type="{http://xml.comcast.com/location/types}CopyLocationToBillingRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "copyLocationToBilling", namespace = "http://xml.comcast.com/location/services")
public class CopyLocationToBilling {

    @XmlElementRef(name = "CopyLocationToBilling", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
