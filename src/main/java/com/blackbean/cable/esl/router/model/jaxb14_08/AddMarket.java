 ...
 *       &lt;sequence>
 *         &lt;element name="AddMarket" type="{http://xml.blackbean.com/location/types}AddMarketRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "addMarket", namespace = "http://xml.blackbean.com/location/services")
public class AddMarket {

    @XmlElementRef(name = "AddMarket", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
