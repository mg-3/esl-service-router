 ...
 *       &lt;sequence>
 *         &lt;element name="standardizeAddressByRuleReturn" type="{http://xml.comcast.com/location/types}StandardizeAddressResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "standardizeAddressByRuleResponse", namespace = "http://xml.comcast.com/location/services")
public class StandardizeAddressByRuleResponse {

    @XmlElementRef(name = "standardizeAddressByRuleReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
