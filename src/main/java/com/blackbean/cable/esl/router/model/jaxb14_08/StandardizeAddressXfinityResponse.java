 ...
 *       &lt;sequence>
 *         &lt;element name="standardizeAddressXfinityReturn" type="{http://xml.comcast.com/location/types}StandardizeAddressXfinityResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "standardizeAddressXfinityResponse", namespace = "http://xml.comcast.com/location/services")
public class StandardizeAddressXfinityResponse {

    @XmlElementRef(name = "standardizeAddressXfinityReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
