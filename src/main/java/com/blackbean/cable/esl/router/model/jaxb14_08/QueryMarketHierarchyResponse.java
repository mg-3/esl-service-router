 ...
 *       &lt;sequence>
 *         &lt;element name="queryMarketHierarchyReturn" type="{http://xml.comcast.com/location/types}QueryMarketHierarchyResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryMarketHierarchyResponse", namespace = "http://xml.comcast.com/location/services")
public class QueryMarketHierarchyResponse {

    @XmlElementRef(name = "queryMarketHierarchyReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
