 ...
 *       &lt;sequence>
 *         &lt;element name="queryMarketByBoundaryReturn" type="{http://xml.blackbean.com/location/types}QueryMarketByBoundaryResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryMarketByBoundaryResponse", namespace = "http://xml.blackbean.com/location/services")
public class QueryMarketByBoundaryResponse {

    @XmlElementRef(name = "queryMarketByBoundaryReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
