 ...
 *       &lt;sequence>
 *         &lt;element name="QueryMarketByBoundary" type="{http://xml.comcast.com/location/types}QueryMarketByBoundaryRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryMarketByBoundary", namespace = "http://xml.comcast.com/location/services")
public class QueryMarketByBoundary {

    @XmlElementRef(name = "QueryMarketByBoundary", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
