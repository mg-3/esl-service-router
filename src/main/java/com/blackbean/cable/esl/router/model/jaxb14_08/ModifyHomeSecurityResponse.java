 ...
 *       &lt;sequence>
 *         &lt;element name="modifyHomeSecurityReturn" type="{http://xml.blackbean.com/location/types}ModifyHomeSecurityResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "modifyHomeSecurityResponse", namespace = "http://xml.blackbean.com/location/services")
public class ModifyHomeSecurityResponse {

    @XmlElementRef(name = "modifyHomeSecurityReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
