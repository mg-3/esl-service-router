 ...
 *       &lt;sequence>
 *         &lt;element name="QueryLocationByRule" type="{http://xml.blackbean.com/location/types}QueryLocationByRuleRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryLocationByRule", namespace = "http://xml.blackbean.com/location/services")
public class QueryLocationByRule {

    @XmlElementRef(name = "QueryLocationByRule", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
