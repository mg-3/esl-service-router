 ...
 *       &lt;sequence>
 *         &lt;element name="QueryLocationQueue" type="{http://xml.blackbean.com/location/types}QueryLocationQueueRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryLocationQueue", namespace = "http://xml.blackbean.com/location/services")
public class QueryLocationQueue {

    @XmlElementRef(name = "QueryLocationQueue", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
