 ...
 *       &lt;sequence>
 *         &lt;element name="updateLocationInBillingReturn" type="{http://xml.comcast.com/location/types}UpdateLocationInBillingResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "updateLocationInBillingResponse", namespace = "http://xml.comcast.com/location/services")
public class UpdateLocationInBillingResponse {

    @XmlElementRef(name = "updateLocationInBillingReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
