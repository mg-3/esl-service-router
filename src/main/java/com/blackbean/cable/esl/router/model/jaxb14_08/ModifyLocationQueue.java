 ...
 *       &lt;sequence>
 *         &lt;element name="ModifyLocationQueue" type="{http://xml.blackbean.com/location/types}ModifyLocationQueueRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "modifyLocationQueue", namespace = "http://xml.blackbean.com/location/services")
public class ModifyLocationQueue {

    @XmlElementRef(name = "ModifyLocationQueue", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
