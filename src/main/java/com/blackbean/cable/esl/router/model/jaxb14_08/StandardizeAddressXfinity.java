 ...
 *       &lt;sequence>
 *         &lt;element name="StandardizeAddressXfinity" type="{http://xml.comcast.com/location/types}StandardizeAddressXfinityRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "standardizeAddressXfinity", namespace = "http://xml.comcast.com/location/services")
public class StandardizeAddressXfinity {

    @XmlElementRef(name = "StandardizeAddressXfinity", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
