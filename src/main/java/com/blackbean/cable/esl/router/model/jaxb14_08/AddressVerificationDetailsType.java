 ...
 *       &lt;sequence>
 *         &lt;element name="LocationGeographyVerification" type="{http://xml.comcast.com/location/types}LocationGeographyType" minOccurs="0"/>
 *         &lt;element name="LocationTelephonyVerification" type="{http://xml.comcast.com/location/types}LocationTelephonyType" minOccurs="0"/>
 *         &lt;element name="AlternateAddressStatus" type="{http://xml.comcast.com/location/types}AlternateAddressStatusType"/>
 *         &lt;element name="LocationGeographicCoordinatesVerification" type="{http://xml.comcast.com/location/types}GeographicCoordinatePointType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
