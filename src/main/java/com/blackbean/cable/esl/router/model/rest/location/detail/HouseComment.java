...
public class HouseComment {
    ...
    public HouseComment withIndex(long index) {
        this.index = index;
        return this;
    }
    ...
    public HouseComment withValue(Object value) {
        this.value = value;
        return this;
    }
    ...
    public HouseComment withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HouseComment) == false) {
            return false;
        }
        HouseComment rhs = ((HouseComment) other);
