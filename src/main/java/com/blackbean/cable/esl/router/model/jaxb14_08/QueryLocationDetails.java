 ...
 *       &lt;sequence>
 *         &lt;element name="QueryLocationDetails" type="{http://xml.comcast.com/location/types}QueryLocationDetailsRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryLocationDetails", namespace = "http://xml.comcast.com/location/services")
public class QueryLocationDetails {

    @XmlElementRef(name = "QueryLocationDetails", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
