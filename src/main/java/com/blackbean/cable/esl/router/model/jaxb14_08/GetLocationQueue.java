 ...
 *       &lt;sequence>
 *         &lt;element name="GetLocationQueue" type="{http://xml.blackbean.com/location/types}GetLocationQueueRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getLocationQueue", namespace = "http://xml.blackbean.com/location/services")
public class GetLocationQueue {

    @XmlElementRef(name = "GetLocationQueue", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
