 ...
 *       &lt;sequence>
 *         &lt;element name="CopyDuplicateHouseToBilling" type="{http://xml.comcast.com/location/types}CopyDuplicateHouseToBillingRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "copyDuplicateHouseToBilling", namespace = "http://xml.comcast.com/location/services")
public class CopyDuplicateHouseToBilling {

    @XmlElementRef(name = "CopyDuplicateHouseToBilling", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
