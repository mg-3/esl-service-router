 ...
 *       &lt;sequence>
 *         &lt;element name="queryLocationByRuleReturn" type="{http://xml.comcast.com/location/types}QueryLocationResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryLocationByRuleResponse", namespace = "http://xml.comcast.com/location/services")
public class QueryLocationByRuleResponse {

    @XmlElementRef(name = "queryLocationByRuleReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
