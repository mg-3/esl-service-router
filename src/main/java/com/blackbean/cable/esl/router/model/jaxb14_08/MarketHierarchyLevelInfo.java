 ...
 *       &lt;sequence>
 *         &lt;element name="marketHierarchy" type="{http://xml.blackbean.com/location/types}ArrayOfMarketHierarchyLevelResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class MarketHierarchyLevelInfo {
    ...
    @XmlElementRef(name = "marketHierarchy", namespace = "http://xml.blackbean.com/location/types", type = JAXBElement.class, required = false)
