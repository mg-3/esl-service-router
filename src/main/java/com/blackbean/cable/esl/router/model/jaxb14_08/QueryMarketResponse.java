 ...
 *       &lt;sequence>
 *         &lt;element name="queryMarketReturn" type="{http://xml.comcast.com/location/types}QueryMarketResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryMarketResponse", namespace = "http://xml.comcast.com/location/services")
public class QueryMarketResponse {

    @XmlElementRef(name = "queryMarketReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
