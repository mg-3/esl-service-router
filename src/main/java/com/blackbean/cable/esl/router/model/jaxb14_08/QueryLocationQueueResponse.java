 ...
 *       &lt;sequence>
 *         &lt;element name="queryLocationQueueReturn" type="{http://xml.comcast.com/location/types}QueryLocationQueueResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryLocationQueueResponse", namespace = "http://xml.comcast.com/location/services")
public class QueryLocationQueueResponse {

    @XmlElementRef(name = "queryLocationQueueReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
