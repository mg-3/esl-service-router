 ...
 *       &lt;sequence>
 *         &lt;element name="deleteSingleViewAddressAssociationReturn" type="{http://xml.blackbean.com/location/types}ResponseStatusType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "deleteSingleViewAddressAssociationResponse", namespace = "http://xml.blackbean.com/location/services")
public class DeleteSingleViewAddressAssociationResponse {

    @XmlElementRef(name = "deleteSingleViewAddressAssociationReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
