 ...
 *       &lt;sequence>
 *         &lt;element name="QueryLocationReferenceData" type="{http://xml.comcast.com/location/types}QueryLocationReferenceDataRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryLocationReferenceData", namespace = "http://xml.comcast.com/location/services")
public class QueryLocationReferenceData {

    @XmlElementRef(name = "QueryLocationReferenceData", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
