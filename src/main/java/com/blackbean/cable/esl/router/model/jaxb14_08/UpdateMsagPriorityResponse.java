 ...
 *       &lt;sequence>
 *         &lt;element name="updateMsagPriorityReturn" type="{http://xml.blackbean.com/location/types}UpdateMsagPriorityResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "updateMsagPriorityResponse", namespace = "http://xml.blackbean.com/location/services")
public class UpdateMsagPriorityResponse {

    @XmlElementRef(name = "updateMsagPriorityReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
