 ...
 *       &lt;sequence>
 *         &lt;element name="AssociateSingleViewAddress" type="{http://xml.blackbean.com/location/types}AssociateSingleViewAddressType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "associateSingleViewAddress", namespace = "http://xml.blackbean.com/location/services")
public class AssociateSingleViewAddress {

    @XmlElementRef(name = "AssociateSingleViewAddress", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
