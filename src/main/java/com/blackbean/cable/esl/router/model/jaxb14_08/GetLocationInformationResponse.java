 ...
 *       &lt;sequence>
 *         &lt;element name="getLocationInformationReturn" type="{http://xml.comcast.com/location/types}GetLocationInformationResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getLocationInformationResponse", namespace = "http://xml.comcast.com/location/services")
public class GetLocationInformationResponse {

    @XmlElementRef(name = "getLocationInformationReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
