 ...
 *       &lt;sequence>
 *         &lt;element name="GetGeoTag" type="{http://xml.blackbean.com/location/types}GetGeoTagRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getGeoTag", namespace = "http://xml.blackbean.com/location/services")
public class GetGeoTag {

    @XmlElementRef(name = "GetGeoTag", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
