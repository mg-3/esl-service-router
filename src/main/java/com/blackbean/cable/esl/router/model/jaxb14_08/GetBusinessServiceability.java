 ...
 *       &lt;sequence>
 *         &lt;element name="GetBusinessServiceabilityRequest" type="{http://xml.blackbean.com/location/types}GetBusinessServiceabilityRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getBusinessServiceability", namespace = "http://xml.blackbean.com/location/services")
public class GetBusinessServiceability {

    @XmlElementRef(name = "GetBusinessServiceabilityRequest", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
