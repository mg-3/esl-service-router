 ...
 *       &lt;sequence>
 *         &lt;element name="queryLocationReferenceDataReturn" type="{http://xml.comcast.com/location/types}QueryLocationReferenceDataResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryLocationReferenceDataResponse", namespace = "http://xml.comcast.com/location/services")
public class QueryLocationReferenceDataResponse {

    @XmlElementRef(name = "queryLocationReferenceDataReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
