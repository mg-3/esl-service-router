 ...
 *       &lt;sequence>
 *         &lt;element name="getMarketReturn" type="{http://xml.blackbean.com/location/types}GetMarketResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getMarketResponse", namespace = "http://xml.blackbean.com/location/services")
public class GetMarketResponse {

    @XmlElementRef(name = "getMarketReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
