 ...
 *       &lt;sequence>
 *         &lt;element name="getBillingSystemFormattedAddressReturn" type="{http://xml.comcast.com/location/types}GetBillingSystemFormattedAddressResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getBillingSystemFormattedAddressResponse", namespace = "http://xml.comcast.com/location/services")
public class GetBillingSystemFormattedAddressResponse {

    @XmlElementRef(name = "getBillingSystemFormattedAddressReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
