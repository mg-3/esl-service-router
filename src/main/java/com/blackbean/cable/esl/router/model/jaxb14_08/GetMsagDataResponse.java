 ...
 *       &lt;sequence>
 *         &lt;element name="getMsagDataReturn" type="{http://xml.blackbean.com/location/types}GetMsagDataResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getMsagDataResponse", namespace = "http://xml.blackbean.com/location/services")
public class GetMsagDataResponse {

    @XmlElementRef(name = "getMsagDataReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
