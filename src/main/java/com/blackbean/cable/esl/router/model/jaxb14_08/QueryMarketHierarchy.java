 ...
 *       &lt;sequence>
 *         &lt;element name="QueryMarketHierarchy" type="{http://xml.comcast.com/location/types}QueryMarketHierarchyRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryMarketHierarchy", namespace = "http://xml.comcast.com/location/services")
public class QueryMarketHierarchy {

    @XmlElementRef(name = "QueryMarketHierarchy", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
