 ...
 *       &lt;sequence>
 *         &lt;element name="queryLocationReturn" type="{http://xml.comcast.com/location/types}QueryLocationResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryLocationResponse", namespace = "http://xml.comcast.com/location/services")
public class QueryLocationResponse {

    @XmlElementRef(name = "queryLocationReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
