 ...
 *       &lt;sequence>
 *         &lt;element name="deleteMsagAddressAssociationReturn" type="{http://xml.blackbean.com/location/types}DeleteMsagAddressAssociationResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "deleteMsagAddressAssociationResponse", namespace = "http://xml.blackbean.com/location/services")
public class DeleteMsagAddressAssociationResponse {

    @XmlElementRef(name = "deleteMsagAddressAssociationReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
