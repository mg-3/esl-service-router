 ...
 *       &lt;sequence>
 *         &lt;element name="UpdateLocationInBilling" type="{http://xml.comcast.com/location/types}UpdateLocationInBillingRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "updateLocationInBilling", namespace = "http://xml.comcast.com/location/services")
public class UpdateLocationInBilling {

    @XmlElementRef(name = "UpdateLocationInBilling", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
