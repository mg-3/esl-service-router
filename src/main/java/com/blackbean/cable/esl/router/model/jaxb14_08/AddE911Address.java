 ...
 *       &lt;sequence>
 *         &lt;element name="AddE911Address" type="{http://xml.comcast.com/location/types}AddE911AddressRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "addE911Address", namespace = "http://xml.comcast.com/location/services")
public class AddE911Address {

    @XmlElementRef(name = "AddE911Address", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
