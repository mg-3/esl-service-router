 ...
 *       &lt;sequence>
 *         &lt;element name="getLocationXfinityReturn" type="{http://xml.blackbean.com/location/types}GetLocationXfinityResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getLocationXfinityResponse", namespace = "http://xml.blackbean.com/location/services")
public class GetLocationXfinityResponse {

    @XmlElementRef(name = "getLocationXfinityReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
