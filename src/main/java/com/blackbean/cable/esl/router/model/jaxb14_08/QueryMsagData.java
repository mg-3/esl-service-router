 ...
 *       &lt;sequence>
 *         &lt;element name="QueryMsagData" type="{http://xml.comcast.com/location/types}QueryMsagDataRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryMsagData", namespace = "http://xml.comcast.com/location/services")
public class QueryMsagData {

    @XmlElementRef(name = "QueryMsagData", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
