 ...
 *       &lt;sequence>
 *         &lt;element name="GetLocation" type="{http://xml.blackbean.com/location/types}GetLocationRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getLocation", namespace = "http://xml.blackbean.com/location/services")
public class GetLocation {

    @XmlElementRef(name = "GetLocation", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
