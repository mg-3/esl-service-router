 ...
 *       &lt;sequence>
 *         &lt;element name="getNodeReturn" type="{http://xml.blackbean.com/location/types}GetNodeResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getNodeResponse", namespace = "http://xml.blackbean.com/location/services")
public class GetNodeResponse {

    @XmlElementRef(name = "getNodeReturn", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
