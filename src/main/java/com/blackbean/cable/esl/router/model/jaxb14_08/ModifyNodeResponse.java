 ...
 *       &lt;sequence>
 *         &lt;element name="modifyNodeReturn" type="{http://xml.comcast.com/location/types}ModifyNodeResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "modifyNodeResponse", namespace = "http://xml.comcast.com/location/services")
public class ModifyNodeResponse {

    @XmlElementRef(name = "modifyNodeReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
