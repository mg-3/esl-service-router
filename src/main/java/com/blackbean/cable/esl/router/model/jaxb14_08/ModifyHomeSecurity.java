 ...
 *       &lt;sequence>
 *         &lt;element name="ModifyHomeSecurity" type="{http://xml.blackbean.com/location/types}ModifyHomeSecurityRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "modifyHomeSecurity", namespace = "http://xml.blackbean.com/location/services")
public class ModifyHomeSecurity {

    @XmlElementRef(name = "ModifyHomeSecurity", namespace = "http://xml.blackbean.com/location/services", type = JAXBElement.class, required = false)
