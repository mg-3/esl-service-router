 ...
 *       &lt;sequence>
 *         &lt;element name="deleteNodeReturn" type="{http://xml.comcast.com/location/types}DeleteNodeResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "deleteNodeResponse", namespace = "http://xml.comcast.com/location/services")
public class DeleteNodeResponse {

    @XmlElementRef(name = "deleteNodeReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
