 ...
 *       &lt;sequence>
 *         &lt;element name="standardizeAddressReturn" type="{http://xml.comcast.com/location/types}StandardizeAddressResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "standardizeAddressResponse", namespace = "http://xml.comcast.com/location/services")
public class StandardizeAddressResponse {

    @XmlElementRef(name = "standardizeAddressReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
