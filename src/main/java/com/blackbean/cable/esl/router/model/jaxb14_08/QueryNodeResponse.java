 ...
 *       &lt;sequence>
 *         &lt;element name="queryNodeReturn" type="{http://xml.comcast.com/location/types}QueryNodeResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "queryNodeResponse", namespace = "http://xml.comcast.com/location/services")
public class QueryNodeResponse {

    @XmlElementRef(name = "queryNodeReturn", namespace = "http://xml.comcast.com/location/services", type = JAXBElement.class, required = false)
